-- FTAP V12 RESULTS/DEBUG PACK
local ReplicatedStorage=game:GetService("ReplicatedStorage")
local ENV=_G
if type(getgenv)=="function" then pcall(function() ENV=getgenv() end) end
local A=ENV.FTAPV10
if not A or not A.shared then warn("[FTAP V12 DEBUG] core+shared first"); return end
